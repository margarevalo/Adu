...
async function revertedWithCustomErrorWithArgs(context, Assertion, _utils, expectedArgs, ssfi) {
    ...
    for (const [i, actualArg] of actualArgs.entries()) {
        ...
        if (typeof expectedArg === "function") {
            ...
            assert(expectedLength === actualLength, `Expected the ${ordinal(i + 1)} argument of the "${customError.name}" custom error to have ${expectedLength} ${expectedLength === 1 ? "element" : "elements"}, but it has ${actualLength}`);
